...
mytimer:add_signal("timeout",  function() local fd =  io.popen("/home/bq/Scripts/bat_state.sh") mybat.text =  fd:read("*a") fd:close() end)
...
for s = 1, screen.count() do
    ...
    mywibox[s].widgets = {
        ...
        mytextclock,
	-- mybat,
       -- s == 1 and mysystray and mystatusbar or nil,
